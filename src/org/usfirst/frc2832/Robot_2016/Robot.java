...
public class Robot extends IterativeRobot {
    ...
    public static int gameMode; // 0 is autonDrive, 1 teleopDrive, 2 ingesting, 3 shooting, 4 expelling
    public static boolean isAuton;
    public static boolean isBlue;
    
    public static final int MSGID_MODE = 0x0000012c;
    public static final int MSGID_COLOR = 0x0000012d;
    public static final int MSGID_FIRING = 0x0000012e;
    public static final int MSGID_ENABLE = 0x0000012f;
    public static final int MSGID_DISABLE = 0x00000130;
    ...
    public void robotInit() {
	    RobotMap.init();
	    ByteBuffer data = ByteBuffer.wrap(new byte[]{(byte) (isBlue ? 0 : 1)});
	    CANJNI.FRCNetworkCommunicationCANSessionMuxSendMessage(CANJNI.CAN_SEND_PERIOD_NO_REPEAT | MSGID_COLOR, data, 5000);
    ...
    public void disabledInit(){
    	CANJNI.FRCNetworkCommunicationCANSessionMuxSendMessage(CANJNI.CAN_SEND_PERIOD_NO_REPEAT | MSGID_DISABLE, ByteBuffer.wrap(new byte[]{}), 5000);
    	if (recordedAuton)
    ...
    public void autonomousInit() {
    	gameMode = 0;
    	CANJNI.FRCNetworkCommunicationCANSessionMuxSendMessage(CANJNI.CAN_SEND_PERIOD_NO_REPEAT | MSGID_MODE, ByteBuffer.wrap(new byte[]{(byte) gameMode}), 5000);
    	isAuton = true;
    	if (recordedAuton) {
