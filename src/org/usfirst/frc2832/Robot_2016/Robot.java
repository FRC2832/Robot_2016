...
public class Robot extends IterativeRobot {
    ...
    public static final int MSGID_EVENT = 0x0000012c;
    public static final int MSGID_STATE = 0x0000012d;
    ...
    public void robotInit() {
        ...
        isBlue = false; //TODO replace with 3-way switch result, 0-5/3 V, 5/3-10/3 V, 10/3-5 V
    ...
    public static void sendState(){
    	CANJNI.FRCNetworkCommunicationCANSessionMuxSendMessage(MSGID_STATE, ByteBuffer.wrap(new byte[]{
    			(byte) (isAuton ? 0 : 1), (byte) (isBlue ? 0 : 1), (byte) (isDisabled ? 0 : 1)
    	}), 5000);
    }
    
    public static void sendEvent(byte[] eventData){
    	CANJNI.FRCNetworkCommunicationCANSessionMuxSendMessage(MSGID_EVENT, ByteBuffer.wrap(eventData), 5000);
    }
}
