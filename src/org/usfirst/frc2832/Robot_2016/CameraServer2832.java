...
public class CameraServer2832 {
	  ...
	  public synchronized void setSize(int size, int camID) {
	    ...
	    switch (size) {
	      case kSize640x480:
	        m_camera[camID].setSize(640, 480);
	        break;
	      case kSize320x240:
	        m_camera[camID].setSize(320, 240);
	        break;
	      case kSize160x120:
	        m_camera[camID].setSize(160, 120);
	        break;
	    }
	  }
